         ...
         <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <hr class="horizontal block">
                  <div class="form-group">
                      ...
                      <label>:</label>
                      <label>{{ $pengajuan_permohonan->nama_pemohon }}</label>
                      <br>
                      <label class="font-weight-bold">
                           Alamat Pemohon
                      </label>
                      ...
                      <label>:</label>
                      <label>{{ $pengajuan_permohonan->nama_perusahaan }}</label>
                      <br>
                      <label class="font-weight-bold">
                           Alamat Perusahaan
                      </label>
                      ...
                      <label>:</label>
                      <label>{{ $pengajuan_permohonan->nama_objek }}</label>
                      <br>
                      <label class="font-weight-bold">
                           Lokasi Objek
                      </label>
                      <label>:</label>
                      <label>{{ $pengajuan_permohonan->lokasi_objek }}</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <br>
              ...
              <div class="d-flex justify-content-end">
                <a href="{{ route('pengajuan-permohonan.index') }}" class="btn btn-warning mx-1" role="button">
                  Kembali
              </a>
              </div>
            </div>
