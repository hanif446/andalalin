              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('nama_user') is-invalid @enderror" type="text" name="nama_user" value="{{old('nama_user')}}" placeholder="Nama User">
                    @error('nama_user')
                  ...
                  <div class="form-group">
                    ...
                    <select id="select_user_gender" name="jk" data-placeholder="Pilih Jenis Kelamin" class="form-control @error('jk') is-invalid @enderror">
                      @foreach ($genders as $key => $value)
                        <option value="{{ $key }}" {{ old('jk') == $key ? "selected" : null}}>{{ $value }}</option>
                      @endforeach
                    </select>
                    @error('jk')
                      <span class="invalid-feedback">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('tempat_lahir') is-invalid @enderror" type="text" name="tempat_lahir" value="{{old('tempat_lahir')}}" placeholder="Tempat Lahir">
                    @error('tempat_lahir')
                      <span class="invalid-feedback">
                        <strong>{{$message}}</strong>
                      </span>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('tgl_lahir') is-invalid @enderror" type="date" name="tgl_lahir" value="{{old('tgl_lahir')}}" placeholder="Jenis Kelamin">
                    @error('tgl_lahir')
                      <span class="invalid-feedback">
                        <strong>{{$message}}</strong>
                      </span>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('no_hp') is-invalid @enderror" type="text" name="no_hp" value="{{old('no_hp')}}" placeholder="No Handphone">
                    @error('no_hp')
                      <span class="invalid-feedback">
                        <strong>{{$message}}</strong>
                      </span>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="select_user_role" name="role" data-placeholder="Pilih Role" class="form-control @error('role') is-invalid @enderror">
                    @if (old('role'))
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('password') is-invalid @enderror" type="password" name="password" value="{{old('password')}}" placeholder="Password">
                    @error('password')
                      <span class="invalid-feedback">
                        <strong>{{$message}}</strong>
                      </span>
